...
public class LoadingTip extends LinearLayout {
    ...
    private void initView(Context context) {
        View.inflate(context, R.layout.setting_dialog_loading_tip, this);
    ...
    public void setLoadingTip(LoadStatus loadStatus) {
        switch (loadStatus) {
            case empty:
                ...
                tv_tips.setText(getContext().getText(R.string.setting_empty).toString());
                img_tip_logo.setImageResource(R.drawable.setting_img_no_data);
                break;
            case serverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                ...
                if (TextUtils.isEmpty(errorMsg)) {
                    tv_tips.setText(getContext().getText(R.string.setting_net_error).toString());
                } else {
                    tv_tips.setText(errorMsg);
                }
                img_tip_logo.setImageResource(R.drawable.setting_ic_wrong);
                break;
            case error:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                ...
                img_tip_logo.setImageResource(R.drawable.setting_ic_wifi_off);
                break;
            case loading:
                setVisibility(View.VISIBLE);
                ...
                bt_operate.setVisibility(GONE);
                tv_tips.setText(getContext().getText(R.string.setting_loading).toString());
                break;
            case finish:
                setVisibility(View.GONE);
                break;
